...
# 📖 Microverse-Self-Review-Trial <a name="about-project"></a>

**Microverse-Self-Review-Trial** is a project that is designed befor and now it is used for self reviewing in Microverse
...
https://github.com/MozamelJawad/Microverse-Self-Review-Trial
...
```sh
  cd Microverse-Self-Review-Trial
 npm install
```
